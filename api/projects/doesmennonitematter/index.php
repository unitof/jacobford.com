...
<?php htmlheader($pageClass, $middle, $bottom, true); ?>
	<div id="story">
		<div class="overhang">
			<img <?php htmlsrcset('doesmennomatter_full.png', $pageClass, 3, true); ?> alt="The entire Mennonite USA Confession of Faith, in tiny text, flowed to form the words &ldquo;does mennonite matter&rdquo;. A question mark and event details follow.">
		</div>
